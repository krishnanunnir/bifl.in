-- Initial BIFL India Schema Migration

CREATE TYPE "public"."display_category" AS ENUM('cookware', 'leather_edc', 'appliances', 'timepieces', 'stationery', 'home_hardware');
CREATE TYPE "public"."durability_system" AS ENUM('heirloom_cast_iron', 'full_grain_leather', 'tri_ply_steel', 'mechanical_horology', 'handcrafted_brass_kansa', 'modular_serviceable', 'borosilicate_glass', 'other_durable');
CREATE TYPE "public"."item_status" AS ENUM('In Production', 'Heritage');
...
ALTER TABLE "item_makers" ADD CONSTRAINT "item_makers_item_id_items_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "item_makers" ADD CONSTRAINT "item_makers_maker_id_makers_id_fk" FOREIGN KEY ("maker_id") REFERENCES "public"."makers"("id") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "item_platforms" ADD CONSTRAINT "item_platforms_item_id_items_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "item_platforms" ADD CONSTRAINT "item_platforms_platform_slug_platforms_slug_fk" FOREIGN KEY ("platform_slug") REFERENCES "public"."platforms"("slug") ON DELETE restrict ON UPDATE no action;
ALTER TABLE "item_systems" ADD CONSTRAINT "item_systems_item_id_items_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "variants" ADD CONSTRAINT "variants_item_id_items_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id") ON DELETE cascade ON UPDATE no action;

CREATE INDEX "blog_posts_published_idx" ON "blog_posts" USING btree ("is_published","published_at");
CREATE INDEX "item_makers_order_idx" ON "item_makers" USING btree ("item_id","maker_order");
CREATE INDEX "items_catalog_order_idx" ON "items" USING btree ("catalog_order");
CREATE INDEX "items_published_idx" ON "items" USING btree ("is_published");
